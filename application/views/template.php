        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
              ...
              <ul class="dropdown-menu">
                <!-- Menu Footer-->
                <li>
                    <a href="<?php echo base_url();?>index.php/logout" class="btn btn-warning "><i class="fa fa-sign-out"></i></a>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
       ...
       <div class="pull-left info">
         ...
         <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-circle text-success"></i> Online
